...
from app.time_utils import day_bounds, ensure_aware, parse_duration, parse_start
            ...
            "messages": [
                {
                    ...
                    "content": (
                        ...
                        "attendee_email, booking_uid, reason, date_from, date_to, missing_fields. "
        ...
        try:
            ...
            if exc.response.status_code == 429:
                raise LlmExtractionError(
                    "OpenAI rate limit or quota was reached. Please wait and retry, or use a key/model with available quota."
                ) from exc
            raise LlmExtractionError(
